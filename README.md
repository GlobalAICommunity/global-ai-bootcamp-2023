...
| --- | ---  |
| Title | TBA  |
| Speakers | John Montgomery (Corporate Vice President Azure AI) <br> Bob Breynaert (Principal Program Manager, Azure OpenAI) / Dona Sarkar (Director Of Technology - Accessibility at Microsoft) / Sharon Lo (Principal Program Manager Ethics & Society) |
